---
title: 'Making Spirographs with spiro'
...
vignette: >
  ...
  %\VignetteIndexEntry{Making Spirographs with spiro}
...
Install [spiro](https://github.com/wjschne/spiro) from GitHub by running this code:
