# Getting help with spiro

Thanks for using spiro. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/spiro/issues) to make sure the 
